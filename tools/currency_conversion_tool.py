...
class CurrencyConverterTool:
    ...
    def _setup_tools(self) -> List:
        ...
        def convert_currency(amount:float, from_currency:str, to_currency:str):
            """Convert amount from one currency to another. Use this tool when user asks for currency conversion like 'Convert 100 USD to EUR' or 'What is 50 dollars in euros'"""
